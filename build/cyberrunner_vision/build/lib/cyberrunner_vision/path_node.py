...
class PathNode(Node):
    def __init__(self):
        ...
        self.gui_open   = False
        self.hover_pt   = None     # current mouse position for preview line
    ...
    def _open_gui(self):
        ...
        self.gui_open = True
        self.get_logger().info(
            "Path GUI opened — click points to build path")
