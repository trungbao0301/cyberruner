...
static const _StateEstimateSub_type_support_symbol_names_t _StateEstimateSub_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cyberrunner_interfaces, msg, StateEstimateSub)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cyberrunner_interfaces, msg, StateEstimateSub)),
  }
};
...
{
  return &::cyberrunner_interfaces::msg::rosidl_typesupport_cpp::StateEstimateSub_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, cyberrunner_interfaces, msg, StateEstimateSub)() {
  return get_message_type_support_handle<cyberrunner_interfaces::msg::StateEstimateSub>();
}
